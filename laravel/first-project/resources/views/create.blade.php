                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100"
                            ...
                            <li class="nav-item w-100">
                                ...
                                <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                    <li class="w-100">
                                        <a href="/clientes/" class="nav-link px-0 text-body"> <span
                        ...
                        <div class="d-grid gap-3 d-fill">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 flex-fill">
                                    ...
                                    <input type="text" name="sobrenome" id="descriptions" required class="form-control">
                                </div>

                                <div class="form-group col-md-3 flex-fill">
                                    <label for="valor">Idade</label>
                                    <input type="text" name="idade" id="idade" required class="form-control">
                                </div>
                            </div>
